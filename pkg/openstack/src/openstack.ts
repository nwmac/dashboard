export class Openstack {
  ...
  public async getFlavors(value: any, initial?: string) {
    return this.getOptions(value, '/flavors', 'flavors', undefined, initial);
  }

  public async getImages(value: any, initial?: string) {
    return this.getOptions(value, '/images/detail', 'images', undefined, initial);
  }

  public async getKeyPairs(value: any, initial?: string) {
    return this.getOptions(value, '/os-keypairs', 'keypairs', (v: any) => v.keypair, initial);
  }

  public async getSecurityGroups(value: any, initial?: string) {
    return this.getOptions(value, '/os-security-groups', 'security_groups', undefined, initial);
  }

  public async getFloatingIpPools(value: any, initial?: string) {
    return this.getOptions(value, '/os-floating-ip-pools', 'floating_ip_pools', undefined, initial);
  }

  public async getNetworkNames(value: any, initial?: string) {
    return this.getOptions(value, '/os-tenant-networks', 'networks', (network: any) => {
      return {
        ... network,
        name: network.label
      };
  ...
  public async getAvailabilityZones(value: any, initial?: string) {
    return this.getOptions(value, '/os-availability-zone', 'availabilityZoneInfo', (zone: any) => {
      return {
        ... zone,
        name: zone.zoneName
      };
